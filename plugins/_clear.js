...
function cleanSubbotDirectories() {
  for (const [name, path] of Object.entries(paths)) {
    if (name === 'MitsuriSession') continue; // Skip SanSession for this function
...
function cleanYukiSession() {
  const sessionPath = paths.YukiSession;
...
setInterval(cleanYukiSession, 60 * 1000);
