...
let handler = async (m, { conn, text }) => {
    ...
    try {
        ...
        if (text.includes('-o') || text === 'o') {
            data = await fs.readFile('./src/database/pj_venta.json', 'utf-8')
            pjs = JSON.parse(data)
            ...
            let userData
            try {
                userData = await fs.readFile('./src/database/userData.json', 'utf-8')
            } catch (error) {
                userData = '{}'
            }
            ...
            delete pjs[nombre]
            await fs.writeFile('./src/database/pj_venta.json', JSON.stringify(pjs, null, 2))
            ...
            data = await fs.readFile('./src/database/person.json', 'utf-8')
            pjs = JSON.parse(data)
            ...
            await fs.writeFile('./src/database/person.json', JSON.stringify(pjs, null, 2))
